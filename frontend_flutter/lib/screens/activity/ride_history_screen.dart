      ...
      body: Column(
        children: [
          ...
          Expanded(
            ...
            ? Center(child: Text("No rides found", style: TextStyle(color: textGrey)))
            : ListView.separated(
    ...
    return Expanded(
      child: GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: isActive ? const Color(0xFF10B981) : Colors.transparent, // Active Green
        ...
        children: [
            ...
            children: [
              ...
              Text(
                ...
                style: TextStyle(
                  fontWeight: FontWeight.bold,
                  fontSize: 16,
                  color: isCancelled ? Colors.grey[400] : const Color(0xFF10B981),
                ),
              ),
            ],
          ),
          ...
          Row(
            ...
            children: [
              ...
              Column(
                children: [
                  const Icon(Icons.radio_button_unchecked, size: 14, color: Color(0xFF10B981)),
                  Container(
                    height: 24,
                    width: 2,
                  ...
                  children: [
                    Text(
                      ...
                      style: TextStyle(
                        fontWeight: FontWeight.w600,
                        fontSize: 14,
                        color: isCancelled ? Colors.grey[400] : const Color(0xFF1F2937),
                      ),
                      maxLines: 1,
                      overflow: TextOverflow.ellipsis,
                    ),
                    const SizedBox(height: 14), // Spacing to match dotted line height
                    Text(
                      data['dropoff'],
                      style: TextStyle(
                        fontWeight: FontWeight.w600,
